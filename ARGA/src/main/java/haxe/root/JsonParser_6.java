...
public class JsonParser_6 extends json2object.reader.BaseParser<jackbergus.dgep.internals.ResponseAndData>
{
	public JsonParser_6(haxe.lang.EmptyObject empty)
	{
	...
	public JsonParser_6(haxe.root.Array<json2object.Error> errors, json2object.PositionUtils putils, java.lang.Object errorType)
	{
		//line 963 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
		super(haxe.lang.EmptyObject.EMPTY);
		//line 963 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
		haxe.root.JsonParser_6.__hx_ctor__JsonParser_6(this, errors, putils, errorType);
	}
	
	
	protected static void __hx_ctor__JsonParser_6(haxe.root.JsonParser_6 __hx_this, haxe.root.Array<json2object.Error> errors, json2object.PositionUtils putils, java.lang.Object errorType)
	{
		...
		//line 963 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
		json2object.reader.BaseParser.__hx_ctor_json2object_reader_BaseParser(((json2object.reader.BaseParser<jackbergus.dgep.internals.ResponseAndData>) (__hx_this) ), ((haxe.root.Array<json2object.Error>) (errors) ), ((json2object.PositionUtils) (putils) ), ((int) (haxe.lang.Runtime.toInt(errorType1)) ));
		//line 963 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
	...
	@Override public void onIncorrectType(java.lang.Object pos, java.lang.String variable)
	{
		...
		this.errors.push(json2object.Error.IncorrectType(variable, "jackbergus.dgep.internals.ResponseAndData", pos));
	...
	@Override public void loadJsonObject(haxe.root.Array<hxjsonast.JObjectField> o, java.lang.Object pos, java.lang.String variable)
	{
		...
		this.objectSetupAssign(assigned, new haxe.root.Array<java.lang.String>(new java.lang.String[]{"response", "data"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{false, false}));
					...
					if (( __temp_svar1 != null )) 
					{
						...
						switch (__temp_svar1.hashCode())
						{
							case 3076010:
							{
								...
								if (__temp_svar1.equals("data")) 
								{
									//line 439 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
									__temp_executeDef2 = false;
									//line 376 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
									this.value.data = ((haxe.ds.StringMap<java.lang.String>) (this.loadObjectField(((haxe.lang.Function) (new haxe.lang.Closure(new haxe.root.JsonParser_4(((haxe.root.Array<json2object.Error>) (this.errors) ), ((json2object.PositionUtils) (this.putils) ), ((int) (1) )), "loadJson")) ), field, "data", assigned, ((java.lang.Object) (this.value.data) ), pos)) );
								}
							...
							{
								//line 376 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
								if (__temp_svar1.equals("response")) 
								{
									//line 439 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
									__temp_executeDef2 = false;
									//line 376 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
									this.value.response = ((haxe.ds.StringMap<haxe.ds.List<jackbergus.dgep.internals.Move>>) (this.loadObjectField(((haxe.lang.Function) (new haxe.lang.Closure(new haxe.root.JsonParser_8(((haxe.root.Array<json2object.Error>) (this.errors) ), ((json2object.PositionUtils) (this.putils) ), ((int) (1) )), "loadJson")) ), field, "response", assigned, ((java.lang.Object) (this.value.response) ), pos)) );
								}
	...
	public jackbergus.dgep.internals.ResponseAndData getAuto()
	{
		//line 459 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
		jackbergus.dgep.internals.ResponseAndData value = new jackbergus.dgep.internals.ResponseAndData(haxe.lang.EmptyObject.EMPTY);
