...
import org.tweetyproject.logics.pl.semantics.PriestWorld;
import org.tweetyproject.logics.pl.semantics.PriestWorld.TruthValue;
...
public class ContensionInconsistencyMeasurementProcess extends InconsistencyMeasurementProcess<PlFormula>{
	...
	/* (non-Javadoc)
	 * @see org.tweetyproject.logics.commons.analysis.streams.InconsistencyMeasurementProcess#init(java.util.Map)
	 */
	...
	/* (non-Javadoc)
	 * @see org.tweetyproject.logics.commons.analysis.streams.InconsistencyMeasurementProcess#update(org.tweetyproject.Formula)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.tweetyproject.logics.commons.analysis.streams.InconsistencyMeasurementProcess#toString()
	 */
	@Override
