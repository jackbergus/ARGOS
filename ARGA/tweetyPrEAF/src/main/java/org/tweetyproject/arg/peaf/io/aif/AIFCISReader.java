...
//    }
    ...
    public static class Exceptions {
        ...
        public static long describe() {
            long count = 0;
            System.out.println("AIFCISReader.UnsupportedNodeTypeException count: " + UnsupportedNodeTypeException.getOccurrenceCount());
            count += UnsupportedNodeTypeException.getOccurrenceCount();
            System.out.println("AIFCISReader.DuplicateNodeIDException count: " + DuplicateNodeIDException.getOccurrenceCount());
            count += DuplicateNodeIDException.getOccurrenceCount();
            return count;
        }
    }
}
