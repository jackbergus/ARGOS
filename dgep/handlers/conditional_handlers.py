...
def handle_event_requirement(dialogue, requirement:EventRequirement, data):
    result = False
...
def handle_role_requirement(dialogue, requirement:InRoleRequirement, data):
...
def handle_inspect_requirement(dialogue, requirement:InspectRequirement, data):
