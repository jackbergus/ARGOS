...
public class NativeInput extends haxe.io.Input
{
	...
	{
		//line 52 "/usr/share/haxe/std/java/io/NativeInput.hx"
		int ret = 0;
		//line 54 "/usr/share/haxe/std/java/io/NativeInput.hx"
		try 
		{
			//line 54 "/usr/share/haxe/std/java/io/NativeInput.hx"
		...
		{
			//line 57 "/usr/share/haxe/std/java/io/NativeInput.hx"
			throw ((java.lang.RuntimeException) (haxe.Exception.thrown(new haxe.io.Eof())) );
		}
		
		catch (java.io.IOException e1)
		{
			//line 59 "/usr/share/haxe/std/java/io/NativeInput.hx"
			throw ((java.lang.RuntimeException) (haxe.Exception.thrown(haxe.io.Error.Custom(e1))) );
		}
		
		
		//line 62 "/usr/share/haxe/std/java/io/NativeInput.hx"
		if (( ret == -1 )) 
		{
			//line 63 "/usr/share/haxe/std/java/io/NativeInput.hx"
			throw ((java.lang.RuntimeException) (haxe.Exception.thrown(new haxe.io.Eof())) );
		}
		
		//line 64 "/usr/share/haxe/std/java/io/NativeInput.hx"
		return ret;
	}
