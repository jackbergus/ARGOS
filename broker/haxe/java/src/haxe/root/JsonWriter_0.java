...
public class JsonWriter_0 extends haxe.lang.HxObject
{
	public JsonWriter_0(haxe.lang.EmptyObject empty)
	{
	}
	
	
	public JsonWriter_0(java.lang.Object ignoreNullOptionals)
	{
		//line 384 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/writer/DataBuilder.hx"
		haxe.root.JsonWriter_0.__hx_ctor__JsonWriter_0(this, ignoreNullOptionals);
	}
	
	
	protected static void __hx_ctor__JsonWriter_0(haxe.root.JsonWriter_0 __hx_this, java.lang.Object ignoreNullOptionals)
	{
	...
	public final haxe.root.JsonWriter_0 dontQuote()
	{
	...
	public java.lang.String _write(jackbergus.dgep.requests.RawParticipantObjectToJSON o, java.lang.String space, java.lang.Object level, java.lang.Object indentFirst, haxe.lang.Function onAllOptionalNull)
	{
		...
		haxe.root.Array<java.lang.String> decl = new haxe.root.Array<java.lang.String>(new java.lang.String[]{( ( ( indent + space ) + "\"participants\": " ) + new haxe.root.JsonWriter_2(((java.lang.Object) (this.ignoreNullOptionals) ))._write(o.participants, space, ( level1 + 1 ), false, onAllOptionalNull) )});
		...
		if (this.ignoreNullOptionals) 
		{
			...
			haxe.root.Array<java.lang.Object> skips = new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{false});
	...
	public java.lang.String write(jackbergus.dgep.requests.RawParticipantObjectToJSON o, java.lang.String space)
	{
				...
				switch (field.hashCode())
				{
					case 113399775:
					{
						...
						if (field.equals("write")) 
						{
							...
							__temp_executeDef1 = false;
							//line 381 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/writer/DataBuilder.hx"
							return this.write(((jackbergus.dgep.requests.RawParticipantObjectToJSON) (dynargs[0]) ), haxe.lang.Runtime.toString(( (( dynargs.length > 1 )) ? (dynargs[1]) : (null) )));
						}
					...
					case -1461798176:
					{
						...
						if (field.equals("_write")) 
						{
							...
							__temp_executeDef1 = false;
							//line 381 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/writer/DataBuilder.hx"
							return this._write(((jackbergus.dgep.requests.RawParticipantObjectToJSON) (dynargs[0]) ), haxe.lang.Runtime.toString(( (( dynargs.length > 1 )) ? (dynargs[1]) : (null) )), ( (( dynargs.length > 2 )) ? (dynargs[2]) : (null) ), ( (( dynargs.length > 3 )) ? (dynargs[3]) : (null) ), ((haxe.lang.Function) (( (( dynargs.length > 4 )) ? (dynargs[4]) : (null) )) ));
						}
