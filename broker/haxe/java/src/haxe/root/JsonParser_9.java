...
public class JsonParser_9 extends json2object.reader.BaseParser<jackbergus.dgep.messages.DialogueMessage>
{
	public JsonParser_9(haxe.lang.EmptyObject empty)
	{
	...
	public JsonParser_9(haxe.root.Array<json2object.Error> errors, json2object.PositionUtils putils, java.lang.Object errorType)
	{
		//line 963 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
		super(haxe.lang.EmptyObject.EMPTY);
		//line 963 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
		haxe.root.JsonParser_9.__hx_ctor__JsonParser_9(this, errors, putils, errorType);
	}
	
	
	protected static void __hx_ctor__JsonParser_9(haxe.root.JsonParser_9 __hx_this, haxe.root.Array<json2object.Error> errors, json2object.PositionUtils putils, java.lang.Object errorType)
	{
		...
		//line 963 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
		json2object.reader.BaseParser.__hx_ctor_json2object_reader_BaseParser(((json2object.reader.BaseParser<jackbergus.dgep.messages.DialogueMessage>) (__hx_this) ), ((haxe.root.Array<json2object.Error>) (errors) ), ((json2object.PositionUtils) (putils) ), ((int) (haxe.lang.Runtime.toInt(errorType1)) ));
		//line 963 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
	...
	@Override public void onIncorrectType(java.lang.Object pos, java.lang.String variable)
	{
		...
		this.errors.push(json2object.Error.IncorrectType(variable, "jackbergus.dgep.messages.DialogueMessage", pos));
	...
	@Override public void loadJsonObject(haxe.root.Array<hxjsonast.JObjectField> o, java.lang.Object pos, java.lang.String variable)
	{
		...
		this.objectSetupAssign(assigned, new haxe.root.Array<java.lang.String>(new java.lang.String[]{"moves", "dialogueID"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{false, false}));
					...
					if (( __temp_svar1 != null )) 
					{
						...
						switch (__temp_svar1.hashCode())
						{
							case -1384067853:
							{
								...
								if (__temp_svar1.equals("dialogueID")) 
								{
									//line 439 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
									__temp_executeDef2 = false;
									//line 376 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
									this.value.dialogueID = haxe.lang.Runtime.toString(this.loadObjectField(((haxe.lang.Function) (new haxe.lang.Closure(new haxe.root.JsonParser_5(((haxe.root.Array<json2object.Error>) (this.errors) ), ((json2object.PositionUtils) (this.putils) ), ((int) (1) )), "loadJson")) ), field, "dialogueID", assigned, ((java.lang.Object) (this.value.dialogueID) ), pos));
								}
							...
							{
								//line 376 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
								if (__temp_svar1.equals("moves")) 
								{
									//line 439 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
									__temp_executeDef2 = false;
									//line 376 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
									this.value.moves = ((jackbergus.dgep.internals.ResponseAndData) (this.loadObjectField(((haxe.lang.Function) (new haxe.lang.Closure(new haxe.root.JsonParser_6(((haxe.root.Array<json2object.Error>) (this.errors) ), ((json2object.PositionUtils) (this.putils) ), ((int) (1) )), "loadJson")) ), field, "moves", assigned, ((java.lang.Object) (this.value.moves) ), pos)) );
								}
	...
	public jackbergus.dgep.messages.DialogueMessage getAuto()
	{
		//line 459 "/home/giacomo/haxelib/json2object/3,11,0/src/json2object/reader/DataBuilder.hx"
		jackbergus.dgep.messages.DialogueMessage value = new jackbergus.dgep.messages.DialogueMessage(haxe.lang.EmptyObject.EMPTY);
