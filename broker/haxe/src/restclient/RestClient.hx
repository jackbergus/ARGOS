// https://raw.githubusercontent.com/tbrosman/haxe-rest-client/master/restclient/RestClient.hx
package restclient;
...
class RestClient
{
    ...
    private static function request(verb:String, 
                                    url:String, 
                                    parameters:Map<String, String> = null, 
                                    async:Bool = false, 
                                    onData:String->Void = null, 
                                    onError:String->Void = null):String
    {
        var result:String;
