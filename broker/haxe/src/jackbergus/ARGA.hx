...
import jackbergus.protocol.ProposerOrPublisher.ProposerOrPublisher;
...
class Main {
    static function main() {
        ...
        var dl:DialogueLogic = pl.newDialogue("0", participants, "service1");
        

        
       /* var i1 = new Interaction("Subscribe", "service1", "service1");
        i1.add("s", "service1");
